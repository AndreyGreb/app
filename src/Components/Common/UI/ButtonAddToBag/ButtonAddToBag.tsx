...
import style from './ButtonAddToBag.module.scss'

interface IButtonAddBag {
  addProductBag:(value:any) => void
}

const ButtonAddToBag:FC<IButtonAddBag> = ({addProductBag}:IButtonAddBag) => {
    ...
    return (
        ...
        <button onClick={addProductBag} className={style.buttonAdd} type="button">ADD TO BAG</button>
        <button className={style.buttonLike} type="button">
        <svg
              width="28"
              height="24"
              viewBox="0 0 28 24"
